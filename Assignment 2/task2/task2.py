...
season1.teams['Zenit St Petersburg'].add_player(Player('Jordan', 'Loyd', 2, 'USA', 'Guard',
                                                        ...
                                                        14.4))
season1.teams['Zalgiris Kaunas'].add_player(Player('Niels', 'Giffey', 100, 'Germany',
                                                    'Forward', 5.6, 2.6, 0.7, 0.5, 0.1,
                                                    4.7))
season1.teams['Zalgiris Kaunas'].add_player(Player('Karolis', 'Lukosiunas', 50, 'Lithuania',
                                                    'Forward', 3.1, 0.8, 0.5, 0.3, 0.0,
                                                    0.9))
season1.teams['Zalgiris Kaunas'].add_player(Player('Tai', 'Webster', 70, 'New Zealand',
                                                    'Guard', 4.6, 1.1, 1.8, 0.4, 0.1,
                                                    2.8))
season1.teams['Zalgiris Kaunas'].add_player(Player('Paulius', 'Jankunas', 77, 'Lithuania',
                                                    'Guard', 4.6, 1.1, 1.8, 0.4, 0.1,
                                                    2.8))
